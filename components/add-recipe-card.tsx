...
export function AddRecipeCard({ categories, onCreated }: { categories: string[]; onCreated: (recipe: Recipe) => void }) {
  ...
  return <section className="w-full max-w-2xl justify-self-start rounded-3xl border border-orange-100 bg-white p-5 shadow-sm sm:p-7 lg:max-w-none lg:rounded-none lg:border-x-0 lg:border-t-0 lg:border-b-2 lg:bg-transparent lg:px-0 lg:pb-10 lg:pt-0 lg:shadow-none">

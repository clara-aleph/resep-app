...
export function Dashboard() {
  ...
  return <main className="min-h-screen bg-[#fffaf5] px-4 py-6 sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl">
    <header className="mb-8 flex items-center justify-between gap-3"><Link href="/" className="flex items-center gap-2 text-xl font-black tracking-tight text-stone-900"><span className="grid h-10 w-10 place-items-center rounded-2xl bg-orange-600 text-white"><Soup size={22}/></span>Koleksi Resepku</Link><button onClick={() => setShowSearch(!showSearch)} className="shrink-0 rounded-lg bg-orange-500 px-3 py-2 text-base font-bold text-white shadow-sm hover:bg-orange-600"><Search className="mr-1 inline" size={17}/>Cari Bahan/Resep</button></header>
